...
A web application to reserve rooms in the Healy Family Student Center at Georgetown University, created in Python with the Flask framework. Allows users to login with their Google accounts (via OAuth). Interfaces with a Google Sheets database.

![](https://github.com/chrissdelaney/reserve-hfsc/blob/d2bad8101dc308ba85489e97eb2e96352b0c1111/reserve-hfsc-website.PNG))
